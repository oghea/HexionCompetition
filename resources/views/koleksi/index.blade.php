	...
	<section class="about-info">
		<div class="container">
			<div class="col-sm-6 text-center" style="margin-top: 50px;">
				<img src="img/p5.jpg" style="height: 400px;width: 350px;">
				<div class="col-xs-12" style="margin-top: 30px;">
					<button class="btn">PURCHASE</button>
				</div>
			</div>
			<div class="col-sm-6">
				<p>Published on the occasion of the exhibition Secondhand
					<br>
					August 1, 2014–May 31, 2015
				</p>
				<p>Texts by Vince Aletti, Claire Barliant Conversation with Erik Kessels and Allie Haeusslein</p>
				<p>184 pages | 197 images | 9.5 x 12 in. | Hardcover with acetate dust jacket | 978-0-9839917-6-2</p>
				<p>Edition of 1000 Pier 24 Photography, 2016</p>
				<p>This exhibition catalog expands on our gallery guide with original essays by Vince Aletti and Claire Barliant. In addition to these essays, the catalog features an extended conversation between Erik Kessels and Allie Haeusslein, Associate Director of Pier 24 Photography.</p>
				<p>Pier 24 Photography presents Secondhand, an exhibition featuring artists who build repositories of found images, from which they appropriate, construct, edit, and sequence in order to create something entirely new. Through this process, their distinctly personal approaches become as wide-ranging as their source material. These works are paired alongside selected vernacular photographs from the Pilara Foundation Collection, illustrating another instance in which found pictures can offer new meaning through a simple change of context.</p>
